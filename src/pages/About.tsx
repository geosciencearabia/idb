      ...
      <main className="container mx-auto px-4 py-10 max-w-3xl space-y-8">
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            GeoArabia Dashboard is built on the Integrative Dashboard (IDB) platform (Alqubalee, 2025a, b) and follows the Web-based Interactive Integrated Platform (WIIP) approach for customizing open-source tools for geoscience data (Alqubalee, 2025c). It provides an offline, data-driven view of research activity across topics, institutions, members, and publications using precomputed tables.
          </p>
          <p className="text-muted-foreground">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-6 space-y-1 text-muted-foreground text-sm">
            <li>The dashboard aligns with the WIIP customization approach for integrating heterogeneous geological data into interactive web tools (Alqubalee, 2025c).</li>
            <li>IDB serves as the visualization layer for program-level, institutional, and author-centric analytics (Alqubalee, 2025b).</li>
          </ul>
        </section>
